...
import {tlhTranscriptioXmlEditorConfig} from './editorConfig/tlhXmlEditorConfig';
...
export function writeXml(node: XmlElementNode, editorConfig: XmlEditorConfig = tlhTranscriptioXmlEditorConfig): string {
...
export function DocumentEditor<T>({node: initialNode, download, filename, closeFile, autoSave}: IProps): JSX.Element {
  ...
  const editorConfig = tlhTranscriptioXmlEditorConfig;
